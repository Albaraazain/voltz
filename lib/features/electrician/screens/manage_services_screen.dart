...
class _ManageServicesScreenState extends State<ManageServicesScreen> {
  ...
  Future<void> _addService() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        await context.read<ElectricianProvider>().addService(service);
        if (mounted) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer2<DatabaseProvider, ElectricianProvider>(
        builder: (context, dbProvider, electricianProvider, child) {
                  ...
                  (context, index) {
                    ...
                    return Dismissible(
                      ...
                      onDismissed: (direction) {
                        electricianProvider.deleteService(service.id);
                      },
                      child: Container(
